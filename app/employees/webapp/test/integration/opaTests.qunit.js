...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/mycompany/employees/test/integration/FirstJourney",
    "com/mycompany/employees/test/integration/EmployeesListJourney",
    "com/mycompany/employees/test/integration/EmployeesObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
